...
GO
ALTER TABLE [dbo].[EventAccount] WITH NOCHECK
    ADD CONSTRAINT [FK_dbo.EventAccount_dbo.Account_UID] FOREIGN KEY ([UID]) REFERENCES [dbo].[Account] ([UID]);
...
GO
ALTER TABLE [dbo].[EventComment] WITH NOCHECK
    ADD CONSTRAINT [FK_dbo.EventComment_dbo.Event_EID] FOREIGN KEY ([EID]) REFERENCES [dbo].[Event] ([EID]);
...
ALTER TABLE [dbo].[EventLog] WITH NOCHECK
    ADD CONSTRAINT [FK_dbo.EventLog_dbo.Event_EID] FOREIGN KEY ([EID]) REFERENCES [dbo].[Event] ([EID]);
...
GO
ALTER TABLE [dbo].[EventLog] WITH NOCHECK
    ADD CONSTRAINT [FK_dbo.EventLog_dbo.Account_UID] FOREIGN KEY ([UID]) REFERENCES [dbo].[Account] ([UID]);
